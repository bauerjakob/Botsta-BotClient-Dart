...
part of 'post_message.req.gql.dart';
...
class _$GPostMessageReq extends GPostMessageReq {
  ...
  factory _$GPostMessageReq([void Function(GPostMessageReqBuilder)? updates]) =>
      (new GPostMessageReqBuilder()..update(updates)).build();
  ...
  _$GPostMessageReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GPostMessageReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, 'GPostMessageReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GPostMessageReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GPostMessageReq')
          ..add('vars', vars)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GPostMessageReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
